...
public class Constants {
    public static final String username = "innoist";
    public static final String password = "QWEasd123";
    public static final String baseUrl  = "https://careswebapi.azurewebsites.net/api/";
   // public static final String baseUrl  = "https://192.168.0.104/webapi/";
